...
socNetworkModule.controller('ChatController', ['$scope', '$modal', '$log', '$timeout', 'roomService', 'messageService', function($scope, $modal, $log, $timeout, roomService, messageService) {
    var self = $scope;
    self.setMode = {};
    self.make = '';
